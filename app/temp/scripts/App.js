...
var Menu = function () {
    function Menu() {
        ...
        this.menuContent = (0, _jquery2.default)(".menu");
        this.closeMenuX = (0, _jquery2.default)(".menu__close");
        this.menuLinks = (0, _jquery2.default)(".menu a");
    ...
    _createClass(Menu, [{
        ...
        key: "addSmoothScrooling",
        value: function addSmoothScrooling() {
...
var Modal = function () {
    function Modal() {
        ...
        this.modal = (0, _jquery2.default)(".form-modal");
        this.closeModalButton = (0, _jquery2.default)(".form-modal__close");
        this.events();
    }
